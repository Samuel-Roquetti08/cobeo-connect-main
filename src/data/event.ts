...
export const categorias = [
  { id: "aluno_unifafibe" as const, label: "Aluno UNIFAFIBE", valorCurso: 30 },
  { id: "aluno_externo"   as const, label: "Aluno Externo",   valorCurso: 35 },
  { id: "profissional"    as const, label: "Profissional",    valorCurso: 40 },
] as const;
  ...
  },
  {
    ...
    itens: [
      ...
      },
      {
        ...
        tipo: "curso" as const,
        sessoes: [
          { titulo: "Gengivodesign Suture — Introdução à Microsutura em Periodontia", speaker: "Prof. Me. Renan Souza" },
          { titulo: "Facetas Estratificadas sem Resina Composta com Naturalidade", speaker: "Prof. Dr. Alvaro Augusto Junqueira Júnior" },
          { titulo: "Inovações na Implantodontia", speaker: "Prof. Dr. Paulo Saad" },
          { titulo: "Harmonização com Preenchimento Labial", speaker: "Prof. Dr. Renato Assis Machado" },
        ],
      },
      { hora: "18h–19h",   titulo: "Apresentação de Trabalhos — Presencial", speaker: "", tipo: "break" as const },
...
export const patrocinadores: Patrocinador[] = [
  ...
  { nome: "Alliance Microscopia", logo: allianceMicroscopia, fundoEscuro: true },
  { nome: "DVI", logo: dvi, fundoEscuro: true },
