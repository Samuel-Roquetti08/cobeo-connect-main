...
export const palestrantes = [
  ...
  },
  {
    ...
    instituicao: "UFRJ",
    tag: "Periodontia · UFRJ",
  },
  {
    nome: "Dr. Eduardo Salles",
    foto: "https://i.pravatar.cc/200?img=11",
    especialidade: "Dentística Estética",
    instituicao: "UFMG",
    tag: "Estética · UFMG",
  },
  {
    nome: "Dra. Carolina Veloso",
  ...
  },
  {
    ...
    foto: "https://i.pravatar.cc/200?img=8",
    especialidade: "Prótese Dentária",
    instituicao: "UNIFAFIBE",
    tag: "Prótese · UNIFAFIBE",
  },
];
...
export const programacao = [
  {
    ...
    itens: [
      ...
      { hora: "09:00", titulo: "Abertura Oficial do II COBEO", speaker: "Coordenação UNIFAFIBE" },
      ...
      { hora: "18:00", titulo: "Encerramento do Dia 1", speaker: "" },
    ],
  },
  {
    dia: "Dia 2 — 16/08",
  ...
  },
  {
    ...
    itens: [
      ...
      { hora: "12:30", titulo: "Almoço Livre", speaker: "", tipo: "break" as const },
      { hora: "14:00", titulo: "Premiação dos Melhores Trabalhos", speaker: "Coordenação" },
      { hora: "15:30", titulo: "Conferência de Encerramento", speaker: "Reitor UNIFAFIBE" },
      { hora: "17:00", titulo: "Entrega de Certificados", speaker: "" },
    ],
  },
];
